...
def generate_transactions(accounts):
    ...
    Transactions are generated by simulating random activities such as deposits, withdrawals,
    and transfers. Each transaction includes a timestamp, account number, type, and amount.
...
def write_transactions_to_file(transactions, filename):
    ...
    This function takes a list of transaction records and writes them to a file,
    ensuring each session's data is stored separately and clearly.
    ...
    header = "transaction_time,account_number,transaction_type,amount\n"
...
def main():
    ...
    This function runs indefinitely, simulating a real-world system where transactions
    are constantly occurring and being logged.
    """
    ...
    while True:
        ...
        filename = f"stream/transactions{cnt}.csv"
